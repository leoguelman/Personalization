...
\item In general, population-level counterfactuals can be identified non-parametrically using just the causal graph -- i.e., assuming the conditioning set $Z=\{M\}$ satisfies the backdoor criterion. 
...
\item Counterfactual-based decision-making leads to a fusion of experimental and observational data for personalization.  
