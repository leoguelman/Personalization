...
\item What alternatives do I have to formulate this problem? For instance, what is a suitable causal estimand?
...
$\mathcal{D}^*_{\text{RDC}}(M, I) = ~$\underset{a' \in~{0,1}}{\mathrm{argmax}}~E[\pi_{I=a'}| I=a, M]$
...
\item Interventional inference does not capture the information required to maximize payout.

\end{itemize}

\vskip15pt

\item Counterfactual-based decision-making leads to a fusion of experimental and observational data, which might capture additional information about UHCs required to maximize payout. 
