...
\item Do I need to assume a parametric model to identify this causal estimand?

\item Do I need to assume that the conditioning set $\{M\}$ satisfies the \emph{backdoor criterion} to identify this causal estimand?
...
&  .2750 &\\ \hline
$\mathcal{D}_{IPVR}$& \textbf{Never Purchase Incentive} & .4000 \\ \\ \hline
$\mathcal{D}_{IFR}$& \textbf{Always Purchase Incentive} &  .3150  \\ \\ \hline
$\mathcal{D}_{CI}$ & 
...
& \textbf{.4375}  \\ \hline
$\mathcal{D}_{\text{Oracle}}$ & & \textbf{.4375} \\ \\ 
   \bottomrule
   \end{tabular}
\end{table}
\end{frame}
...
\item In the personalization paradigm, experimental data alone is not `gold standard' for estimating heterogeneous treatment effects in the presence of unobserved and heterogenous confounders.
