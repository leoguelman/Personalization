...
\begin{frame}
[fragile]\frametitle{Personalization with Unobserved Heterogeneity}
...
\item Treatment effect varies according to the value of unobserved variables  (not necessarily confounders)

\vskip7pt

\item Likely the norm in the context of personalization objectives. 
% the optimal action for person A and person B might be different. 
...
\begin{figure}[t]
\includegraphics[width=5cm]{figures/pwu.png}
\centering
\end{figure}
