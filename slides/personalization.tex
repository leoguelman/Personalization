...
\begin{frame}
[fragile]\frametitle{Overview}



\begin{itemize}

\item The idea of Personalization is founded on the premise that individuals have heterogenous response to actions.
% The action that maximizes reward for one client, might not be the best action for another client. 
...
\begin{frame}
[fragile]\frametitle{Approach 3: RCT on All New-to-RBC Clients}
...
\caption{Causal DAG with RCT on All New-to-Bank Clients.}
...
\begin{frame}
[fragile]\frametitle{Approach 3: RCT on All New-to-RBC Clients - cont'd}

\begin{columns}[T] % align columns
\begin{column}{.48\textwidth}

\begin{center}
RCT  $\rightarrow$ $\underset{I \in {0,1}}{\mathrm{argmax}}~E[\pi|do(I), M]$
\end{center}
...
RCT & \textbf{Always Purchase Incentive} &  .3150  \\ \\ \hline
RDC & 
