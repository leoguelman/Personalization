...
\item The experiments destroy information about client intent, which provides information about the unobserved confounders.

\vskip10pt

\item Counterfactual-based decision making, which leads to a fusion of experimental and observational data, has a better chance to succeed when the goal is personalization. 
