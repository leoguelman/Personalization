...
\item \textbf{Business Goal: Personalize the incentive}. Identify which new-to-RBC clients should receive an iPad incentive to maximize the expected profitability of the campaign. 

\begin{equation*}
\text{Profit = Revenue - Cost of iPad}.
\end{equation*}
...
\textbf{Business Goal}: Identify which new-to-RBC clients should receive an iPad incentive to maximize the expected profitability of the campaign.
